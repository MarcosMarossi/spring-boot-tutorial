...
public class Test implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Post post2 =  new Post(null, sdf.parse("19/03/2020"), "Vai viajar?", "Queria saber isso, pois combinamos de irmos juntos", alex);
		Post post3 =  new Post(null, sdf.parse("22/03/2020"), "Bom dia", "Acordei feliz hoje!", bob	);
